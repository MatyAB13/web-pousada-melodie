        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-4 mt-6">
                    ...
                    <button type="submit" className="btn-primary flex-1 flex items-center justify-center gap-2" disabled={isSubmitting}>
                      {isSubmitting ? <><Loader2 className="w-5 h-5 animate-spin" />Enviando...</> : t.confirm}
                    </button>
                  </div>
                </form>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-soft p-6 sticky top-24">
              <h3 className="font-heading text-lg text-primary mb-4">Resumo da Reserva</h3>
              {selected.length > 0 ? (
                ...
                <p className="text-text-secondary text-sm mb-4">Selecione um quarto</p>
              )}
              {checkIn && checkOut && (
                <div className="border-b border-ocean-100 pb-4 mb-4">
                  <div className="flex justify-between text-sm mb-1"><span className="text-text-secondary">Check-in</span><span className="text-text-primary">{checkIn}</span></div>
                  <div className="flex justify-between text-sm mb-1"><span className="text-text-secondary">Check-out</span><span className="text-text-primary">{checkOut}</span></div>
                  <div className="flex justify-between text-sm"><span className="text-text-secondary">noites</span><span className="text-text-primary">{nights}</span></div>
                </div>
              )}
